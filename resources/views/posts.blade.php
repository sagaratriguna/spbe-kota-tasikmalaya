        ...
        <div class="card mb-3">
            ...
            <div class="card-body text-center">
                ...
                <a href="/posts/{{ $posts[0]->slug }}"
                    class="text-decoration-none btn btn-outline-primary">Selengkapnya</a>
            </div>
        </div>
            ...
            <div class="row">
                @foreach ($posts->skip(1) as $post)
                    <div class="col-md-4 mb-3">
                        <div class="card">
                            <div class="position-absolute px-3 py-2" style="background-color: rgba(0, 0, 3, 0.416)"><a
                            ...
                            @else
                                ...
                                <div class="card-body">
                                    ...
                                    <a href="/posts/{{ $post->slug }}" class="btn btn-outline-primary">Selengkapnya</a>
                                </div>
                        </div>
                    </div>
                @endforeach
